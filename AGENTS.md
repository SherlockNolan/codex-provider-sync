...
- in the export TUI, `Ctrl+P` expands an inline preview, `Ctrl+T` opens transcript details, `Tab` shows/hides archived items, and `Delete` toggles the highlighted conversation between active and archived state
